...
\hspace{-.15in}
\begin{tabular}{ll}
    Title of Dissertation:    & {\large DESIGNING EFFECTIVE PROPERTY-BASED}        \\
...
Property-based testing (PBT) is a widely adopted, automated random testing methodology
that combines user-defined logical propositions with automated test case generation.
%

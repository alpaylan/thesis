...
same title as the chapter, ``Programmable Property-Based Testing''~\cn. This is the
result of joint work with Justine, who is the main designer and implementer of the
Racket Programmable PBT library; Ceren, who has worked on the reimplementation of the
existing ETNA workloads in Rocq and Haskell for evaluating our approach; Harry and Leo,
who have been integral to understanding the problem at hand, the design of the
interface as well as exposition of the ideas we presented. I have worked on the core
design of the DBAS encoding, both libraries in Rocq and Racket as well as all of the

...
well as LeanCheck~\cite{leancheck}, and falsify~\cite{falsify} that is not mentioned
in the table.
...
famous of such embeddings is \emph{Higher-Order Abstract Syntax (HOAS)}~\cite{PfenningElliott1988HOAS}, a popular
...
\begin{enumerate}
  ...
  \item Finally, the added expressivity allows these experiments to be expressed as changes to
        ...
        the seed pool affect testing performance, improving FuzzChick~\cite{FuzzChick}
        in the process; in

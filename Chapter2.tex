...
\begin{enumerate}
  ...
  \item Finally, the added expressivity allows these experiments to be expressed as changes to
        ...
        the seed pool affect testing performance, improving FuzzChick\cn{} in the process; in
...
\begin{figure}[h!]
  ...
  \end{minipage}%
  \caption{Original sizes (continuous) and shrunk sizes (dashed) across tasks (x axis)

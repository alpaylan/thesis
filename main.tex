...
\phantomsection %create the correct anchor for the bookmark
\vspace*{-2.5cm}   %raising the Table of Contents to 1 inch top margin
...
\phantomsection %create the correct anchor for the bookmark
\vspace*{-2.5cm} \addcontentsline{toc}{chapter}{List of Tables}
...
\input{Bibliography} %To be used when typing your own bibliography
